...
class _DynamicSignupScreenState extends State<DynamicSignupScreen> {
  ...
  Future<void> _handleSignup() async {
    ...
    try {
      ...
      // 2. حفظ البيانات في Firestore (مهم جداً للـ AuthWrapper)
      ...
      // 3. التوجيه الذكي (التعديل لضمان حفظ الجلسة)
      if (mounted) {
        // نعود للـ SplashScreen أو auth_check ليقوم النظام بتوجيه المستخدم تلقائياً
        // بناءً على البيانات التي حُفظت لتوها. هذا يضمن "تذكر الحساب" مستقبلاً.
