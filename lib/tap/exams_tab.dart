...
class _StudentQuizScreenState extends State<StudentQuizScreen> {
        ...
        actions: [
          Center(
            child: ElevatedButton(
              ...
              onPressed: () {
                // الكود القديم للعودة لأول صفحة في التطبيق تماماً
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("باقي: $timeStr"),
        centerTitle: true,
        backgroundColor: const Color(0xFF292F91),
        foregroundColor: Colors.white,
        elevation: 0,
        // سهم الرجوع للعودة للصفحة السابقة مباشرة (قائمة الامتحانات)
        leading: IconButton(
